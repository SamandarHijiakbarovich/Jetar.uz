...
namespace Jetar.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260909074204_PivotToClassifiedsAndBoost")]
    partial class PivotToClassifiedsAndBoost
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Jetar.Domain.Entities.BoostRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("boost_requests", (string)null);
                });
            ...
            modelBuilder.Entity("Jetar.Domain.Entities.BoostRequest", b =>
                {
                    ...
                    b.HasOne("Jetar.Domain.Entities.User", "ReviewedBy")
                        .WithMany()
